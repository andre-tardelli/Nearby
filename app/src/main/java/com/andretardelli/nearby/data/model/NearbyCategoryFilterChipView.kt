package com.andretardelli.nearby.data.model
...
enum class NearbyCategoryFilterChipView (
    ...
    ALIMENTAÇÃO(description = "Alimentação", icon = R.drawable.ic_tools_kitchen_2),
    ...
    ENTRETERNIMENTO(description = "Cinema", icon = R.drawable.ic_movie),
